import {getAtPath, startsWith, stringify} from '@bjoerge/mutiny/path'
import {applyNodePatch} from '@bjoerge/mutiny/_unstable_apply'
import {makePatches, stringifyPatches} from '@sanity/diff-match-patch'
import {takeUntilRight} from '../utils/arrayUtils'
import type {Path} from '@bjoerge/mutiny/path'
import type {NodePatch, Operation, SanityDocumentBase} from '@bjoerge/mutiny'
