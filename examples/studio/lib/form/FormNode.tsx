...
import {getInstanceName, isDocumentSchema, isObjectSchema} from 'sanitype'
import {at, patch, setIfMissing} from '@bjoerge/mutiny'
import type {
  Infer,
  ObjectFormDef,
  SanityDocument,
...
import type {Path, PathElement} from '@bjoerge/mutiny'
